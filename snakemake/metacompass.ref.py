...
import os
ruleorder: bowtie2_map > build_contigs > assembled_references >pilon_map > sam_to_bam > bam_sort > pilon_contigs >  assemble_unmapped > join_contigs > create_tsv >stats_all >stats_genome >mapping_stats
