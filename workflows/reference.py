    ...
    for s1 in allsamples[0:1]:  
        ...
        if unlock:
            ...
            if unpaired != "" and paired =="":
                cmd_ret +=" --snakefile %s/snakemake/reference_selection.py"%(mcdir)
...
#
        ...
        if i == 0:
            ...
            if ref != "NA":
                ...
                if unpaired != "" and paired =="":
                    cmd += " --snakefile %s/snakemake/reference_selection.py"%(mcdir)
                elif paired != "" and unpaired =="":
                    cmd += " --snakefile %s/snakemake/reference_selection.py"%(mcdir)
                elif paired != "" and unpaired !="":
                    cmd += " --snakefile %s/snakemake/reference_selection.py"%(mcdir)
...
if os.path.exists("%s/%s.%d.assembly.out/mc.refseq.fna"%(prefix,s1id,i-1)):
    #cleanup output
