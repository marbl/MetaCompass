...
# Example usage:
# ./setup_ref_db.sh /fs/cbcb-scratch/zbowen/metacompass/ref_pkg_generation_V2 /fs/cbcb-scratch/zbowen/metacompass/ref_pkg_generation_V2/RefSeq_V2_db/data/prokaryotes.txt
# ./setup_ref_db.sh /fs/cbcb-scratch/zbowen/metacompass/ref_pkg_generation_V2 /fs/cbcb-scratch/zbowen/metacompass/ref_pkg_generation_V2/RefSeq_V2_db/data/prokaryotes.txt
...
## build_ref.sh -------- THIS STEP IS LIKELY SKIPPED -----------------------------------------------------------------------------
...
# # yes | python ${database_dir}/get_sequences_for_refpkg_updated.py  ${database_dir}/RefSeq_V2_db/ ${accession_path} ${version_tag}
